...
public class MainActivity extends AppCompatActivity {
    ...
    if (item.getItemId()==R.id.add_note) {
        Intent intent;
        intent = new Intent(getApplicationContext(), notesEditorActivity.class);
...
return false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView = (ListView)findViewById(R.id.listView);
         ...
         listAdapter=new ArrayAdapter<String>(MainActivity.this,android.R.layout.simple_list_item_1,notes);
